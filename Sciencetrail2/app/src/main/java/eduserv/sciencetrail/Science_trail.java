...
//        mMap.animateCamera(yourLocation);
    ...
    private void loadData(){
        ...
        scienceTrial.add(new MapInformationObject(1,"science", "Dr William Oliver", "Oliver became the leading physician in the city and a founder of the Mineral Water Hospital.\n "  +
        ...
        treeTrial.add(new MapInformationObject(2,"tree", "A Monkey Puzzle/Araucaria Araucana", "Supposedly Archibald Menzies, a plant hunter, pocketed some nuts from a dinner table shared with the governor of Chile. The nuts were planted and grew into the strangest trees he had ever seen. They were christened Araucaria after the Araucaunos Indians and commonly monkey puzzle tree - hard for a monkey to climb! The tree is endangered now in Chile and we possibly have more in Britain - we'll send them some nuts back!\t", 51.3887527777778f, -2.3754998f));
        treeTrial.add(new MapInformationObject(3,"tree", "Spuce/Picea Smithiana", "This tree with droooping twigs is a native of the Himalayas. Look for a diagonal scar 3 metres up on the trunk where it has been struck by lightening.\t", 51.3887361111111f, -2.3767577f));
        treeTrial.add(new MapInformationObject(4,"tree", "Coastal Redwood/Sequoia Sempervirens", "The tallest and some of the oldest trees in the world are redwoods. Feel the spongy, red bark. It's fire-proof and protects the tree in a forest fire; no wonder it's so long-lived. In the USA some trees are estimated to be 2600 yrs old. This one is very wide at 156cm and is likely to be the tallest conifer in the collection.\t", 51.3885527777778f, -2.3771547f));
        treeTrial.add(new MapInformationObject(5,"tree", "Incense Cedar/calocedrus decurrens", "Imagine you were a naturalist 200 years ago, hunting for new plant species. What name would you give your latest find? This tree combines the names of two people: Mr Ehret, a botanical artist, and Mr Dickson, a Scottish naturalist. It has wonderful smelling flowers in the spring. What do you think the bark feels like?\t", 51.3888277777778f, -2.377616f));
        treeTrial.add(new MapInformationObject(6,"tree", "Ehretia dicksonii/Ehretia dicksonii", "Imagine you were a naturalist 200 years ago, hunting for new plant species. What name would you give your latest find? This tree combines the names of two people: Mr Ehret, a botanical artist, and Mr Dickson, a Scottish naturalist. It has wonderful smelling flowers in the spring", 51.3879722222222f, -2.3776241f));
        treeTrial.add(new MapInformationObject(7,"tree", "Weeping Ash/Fraxinus excelsior pendula", "This isn't a champion but it's interesting being as hollow as a toilet roll with twisted branches. Look closely at the top - it looks like an elephant's head with trunk and eyes. ", 51.3879722222222f, -2.376527f));
        treeTrial.add(new MapInformationObject(8,"tree", "Dawn Redwood/Meetasequoia glyptostroboides", "Find the hole in the canopy and enter into another world - wow, a natural tree tent! A love heart has been carved into the bark suggesting some kissing may have gone on here (but please, never carve into a tree)! This tree is very rare and beautiful, one of the best examples in the country. ", 51.387675f, -2.3762159f));
        treeTrial.add(new MapInformationObject(9,"tree", "White Mulberry/Morus alba", "This tree is one of the few deciduous conifers and can grow up to 60m. It was thought to be extinct, known only from some fossilised stumps, until a living example was found by a forester fighting in the Chinese Army during the Second World War. Some American botanists managed to collect seeds and get them out of China just before the communist government closed the borders in 1949.", 51.38745f, -2.3769026f));
        treeTrial.add(new MapInformationObject(10,"tree", "The Indian Bean Tree/Catalpa bignonioides", "(alba means white - the fruits are white). This tree provides the leaves that silk worms feed on. In 1608 James 1st wanted to produce silk in England and had mulberry trees planted. Unfortunately they were black mulberries (with the lovely juicy fruit) not white, so the project failed. It takes 3000 silkworms eating 104kg of leaves to produce 1kg of silk.See the round knobbles on the branch and trunk bark? These are clusters of dormant buds which the tree uses as a kind of old age pension scheme - if anything happens, these will quickly sprout new shoots to grow a new canopy.",51.3874777777778f, -2.3771842f));
        treeTrial.add(new MapInformationObject(11,"tree", "The Glastonbury Thorn/Crataeis monogyna ", "This tree, with its metal support, is neither Indian nor does it have beans but seed pods. It grows best in places with long hot summers (like Bath!). Look inside the open cavity to see the aerial root growing down inside the hollow trunk, showing how resourceful it is - the tree allows its middle to decompose, then recycles the minerals to make new wood.", 51.3874555555556f, -2.3772807f));
        treeTrial.add(new MapInformationObject(12,"tree", "The maidenhair tree/Ginkgo biloba", "A small tree with an old legend attached. The legend relates how Joseph of Arimathea visited Glastonbury with the Holy Grail and when he thrust his staff into a local hill, it grew into a thorn tree. This variety, which is related to our native hawthorn, is special because it flowers twice, in May and again in December. Every year a flowering sprig is cut and presented to the Queen at Christmas.", 51.3878388888889f, -2.377962f));
        treeTrial.add(new MapInformationObject(13,"tree", "The Silver Pendent Lime/Tilla tomentosa", "This tree is a living fossil! The family originated 350 million years ago and took a tree form 200 million years later, at a time when the ferns were the dominant vegetation. Uniquely it has its own species, genus, family and order and is not related to modern day trees. It has only 6 insects which prey on it in its native country, China, unlike our own native oak which has 280.", 51.3874694444444f, -2.3778145f));
        treeTrial.add(new MapInformationObject(14,"tree", "The Fern-leaved Beech/Fagus heteraphylla", "This county champion was recorded as being 5m taller eight years ago but is now in its twilight years - yes, it's dying and getting smaller", 51.3880226f, -2.3753026f));
